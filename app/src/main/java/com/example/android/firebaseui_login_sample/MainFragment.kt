...
class MainFragment : Fragment() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == SIGN_IN_RESULT_CODE) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                Log.i(
                    TAG,
                    "onActivityResult: Unsuccessful sign in user ${response?.error?.errorCode} "
                )
            }
        }
    }
    ...
    private fun launchSignInFlow() {
        ...
        // deliver providers for user to make authentication choice, email with password
        // or google account
        ...
        // Start intent with firebase authentication ui instance and providers
